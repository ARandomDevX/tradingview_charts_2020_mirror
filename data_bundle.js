...
***************************************************************************** */
  ...
  var QuotesPulseProvider = /** @class */ (function () {
    ...
    QuotesPulseProvider.prototype.subscribeQuotes = function (
      ...
      logMessage(
        "QuotesPulseProvider: subscribed quotes with #" + listenerGuid
      );
    };
  ...
  var SymbolsStorage = /** @class */ (function () {
    ...
    SymbolsStorage.prototype._onExchangeDataReceived = function (
      exchange,
      data
    ) {
      var this$1 = this;
      ...
      try {
        ...
        for (; symbolIndex < symbolsCount; ++symbolIndex) {
          ...
          var listedExchange = extractField$1(
            data,
            "exchange-listed",
            symbolIndex
          );
          var tradedExchange = extractField$1(
            data,
            "exchange-traded",
            symbolIndex
          );
          ...
          var ticker = tickerPresent
            ? extractField$1(data, "ticker", symbolIndex)
            : symbolName;
          var symbolInfo = {
            ticker: ticker,
            name: symbolName,
            ...
            has_intraday: definedValueOrDefault(
              extractField$1(data, "has-intraday", symbolIndex),
              false
            ),
            has_no_volume: definedValueOrDefault(
              extractField$1(data, "has-no-volume", symbolIndex),
              false
            ),
            minmov:
              extractField$1(data, "minmovement", symbolIndex) ||
              extractField$1(data, "minmov", symbolIndex) ||
              0,
            minmove2:
              extractField$1(data, "minmove2", symbolIndex) ||
              extractField$1(data, "minmov2", symbolIndex),
            ...
            supported_resolutions: definedValueOrDefault(
              extractField$1(data, "supported-resolutions", symbolIndex),
              this$1._datafeedSupportedResolutions
            ),
            force_session_rebuild: extractField$1(
              data,
              "force-session-rebuild",
              symbolIndex
            ),
            has_daily: definedValueOrDefault(
              extractField$1(data, "has-daily", symbolIndex),
              true
            ),
            intraday_multipliers: definedValueOrDefault(
              extractField$1(data, "intraday-multipliers", symbolIndex),
              ["1", "5", "15", "30", "60"]
            ),
            has_weekly_and_monthly: extractField$1(
              data,
            ...
            volume_precision: definedValueOrDefault(
              extractField$1(data, "volume-precision", symbolIndex),
              0
            ),
          };
